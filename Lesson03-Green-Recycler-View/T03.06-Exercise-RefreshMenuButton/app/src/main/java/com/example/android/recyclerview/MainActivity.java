...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO COMPLETED (2) Create a menu resource in res/menu/ called main.xml
    ...
    // TODO COMPLETED (5) Set the orderInCategory value to 1 to make sure this item is the first in the list
    // TODO COMPLETED (6) Set app:showAsAction to ifRoom to display the menu item in the ActionBar if there is room
