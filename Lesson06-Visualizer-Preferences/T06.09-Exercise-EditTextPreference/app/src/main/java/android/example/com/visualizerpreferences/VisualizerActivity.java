...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        //mVisualizerView.setMinSizeScale(sharedPreferences.getFloat(getString(R.string.pref_size_key),
                //Float.parseFloat(getString(R.string.pref_size_default))));
        float pref_size =  Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_size_key),
                getString(R.string.pref_size_default)));
        mVisualizerView.setMinSizeScale(pref_size);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            float pref_size = Float.parseFloat(sharedPreferences.getString(key, getString(R.string.pref_size_default)));
            mVisualizerView.setMinSizeScale(pref_size);
        }
    }
